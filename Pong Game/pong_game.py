...
pygame.display.set_caption("Heramb's Pong Game")
...
dummy_ball_vel_x, dummy_ball_vel_y = 0.5, 0.5
...
while run:
    ...
    if ball_x >= WIDTH - radius:
        ...
        if dir == 0:
            if ang == 0:
                ball_vel_y, ball_vel_x = -1, 0.5
                dummy_ball_vel_y, dummy_ball_vel_x = -1, 0.5
            if ang == 1:
                ball_vel_y, ball_vel_x = -0.5, 0.5
                dummy_ball_vel_y, dummy_ball_vel_x = -0.5, 0.5
            if ang == 2:
                ball_vel_y, ball_vel_x = -0.5, 1
                dummy_ball_vel_y, dummy_ball_vel_x = -0.5, 1
    ...
    #second pair
        ...
        if left_gadget == 1:
            ...
            second_left_paddl_y = left_paddle_y +200
            left_gadget = 0
            left_gadget_remaining
    ...
    wn.blit(score_2, (825,825))
    gad_left_1 = font.render("Gadget's left: "+str(left_gadget_remaining), True, WHITE)
    wn.blit(gad_left_1, (25,65))
    gad_left_2 = font.render("Gadget's left: "+str(right_gadget_remaining), True, WHITE)
    ...
    if player_1 >= 3:
        ...
        endscreen.blit(endscreen, (200,250))
